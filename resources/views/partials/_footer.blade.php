            ...
            <div class="col-md-3">
                <div class="footer-widget fl-wrap">
                    ...
                    <div class="widget-posts fl-wrap">
                        <ul>
                            <li class="clearfix">
                                <a href="#" class="widget-posts-img"><img src="{{URL::to('assets-web\images\all\1.jpeg')}}" class="respimg" alt=""></a>
                            ...
                            <li class="clearfix">
                                <a href="#" class="widget-posts-img"><img src="{{URL::to('assets-web\images\all\2.jpeg')}}" class="respimg" alt=""></a>
                                <div class="widget-posts-descr">
                            ...
                            <li class="clearfix">
                                <a href="#" class="widget-posts-img"><img src="{{URL::to('assets-web\images\all\3.jpeg')}}" class="respimg" alt=""></a>
                                <div class="widget-posts-descr">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="about-widget">
                        <img src="{{URL::to('assets-web\images\logo.png')}}" alt="">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="copyright"> &#169; Achievers Hub 2018 .  All rights reserved. Designed by <a href="http://www.sitconsulting.org">SIT Consulting</a></div>
                </div>
                <div class="col-md-4">
