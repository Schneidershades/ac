...
@section('content')
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="card-deck">
        @foreach($eventPackages as $event)
        @if($event->id % 2 == 0)
        ...
        @endif
          <img class="card-img-top" src="{{URL::to('assets-web/img/home/ad.png')}}" alt="Card image cap">
          <div class="card-body text-white">
            <h2 class="card-title text-white">N{{$event->amount}}</h2>
            <h5 class="card-title text-white">{{$event->event_package_description}}</h5>
            <a href=""> <button class="card-text"><small>Register Now</small></button></a>
          </div>
        </div>
        @endforeach
      </div>  
