...
<div class="row">
  <div class="col-lg-12 mx-auto">
    <div class="card">
      <div class="card-body">
        <div class="card-title text-uppercase "><i class="fa fa-address-book-o"></i> Create your Event</div>
        <hr>

        <form class="color-form" method="POST" action="{{route('admin-events.store')}}" enctype="multipart/form-data">
          @csrf
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="date" name="from" class="form-control " maxlength="150" required >
            </div>

            <div class="form-group col-md-6">
              <label for="input-13">to</label>
              <input type="date" name="to" class="form-control " maxlength="150" required >
            </div>

            <div class="form-group col-md-12">
              <label for="input-13">Venue</label>
              <textarea name="venue" id="" cols="20" rows="4" class="form-control "></textarea>
            </div>
          ...
          <div class="form-group row">
            <div class="col-sm-10">
              <button type="submit" class="btn btn-primary bg-white text-info shadow px-5"><i class="icon-lock"></i> Register Event</button>
            </div>
          </div>
        </form>
      </div>
