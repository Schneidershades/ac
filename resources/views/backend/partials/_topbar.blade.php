 ...
 <nav class="navbar navbar-expand fixed-top bg-white">
  ...
  <ul class="navbar-nav align-items-center right-nav-link">
    ...
    <li class="nav-item language">
      <a class="nav-link waves-effect" data-toggle="dropdown" href="#"><i class="flag-icon flag-icon-ng"></i></a>
    </li>
    <!-- <li class="nav-item">
      <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
        <span class="user-profile"><img src="{{URL::to(auth()->user()->image) ? URL::to(auth()->user()->image) : 'assets/images/avatars/avatar-17.png'}}" class="img-circle" alt="user avatar"></span>
      </a>
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        ...
        <li class="dropdown-item"><i class="icon-wallet mr-2"></i> My Activities</li>
        <li class="dropdown-divider"></li>
