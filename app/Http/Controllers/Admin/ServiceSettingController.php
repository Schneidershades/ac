...
class ServiceSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.activities.serviceSetting.index')->with('services', $services);
    }
    ...
    {
        return view('admin.activities.serviceSetting.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.activities.serviceSetting.create')->with('service', $service);
    }
